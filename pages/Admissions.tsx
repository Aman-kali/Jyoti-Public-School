  ...
  return (
    <div className="bg-sky-50 min-h-screen">
      <div className="bg-gradient-to-r from-secondary to-secondaryDark py-20 text-center text-white shadow-lg relative overflow-hidden">
        ...
        <h1 className="text-5xl font-extrabold mb-4 text-shadow-sm relative z-10">Admissions</h1>
        <p className="text-white/90 text-xl font-medium relative z-10">Join the Jyoti Public School Family</p>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-card border-l-8 border-primary hover:shadow-xl transition-shadow">
            ...
            <div className="mt-10 p-8 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-200">
          ...
          {/* Enquiry Form */}
          <div className="bg-white p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-100 relative overflow-hidden">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                <div>
                    ...
                    <input 
                        ...
                        className="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-secondary/20 focus:border-secondary outline-none transition-all text-gray-900 placeholder-gray-500" 
                ...
                <div className="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <select 
                            ...
                            onChange={handleChange}
                            className="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-secondary/20 focus:border-secondary outline-none appearance-none cursor-pointer text-gray-900"
                        >
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        onChange={handleChange}
                        className="w-full px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-secondary/20 focus:border-secondary outline-none transition-all h-32 resize-none text-gray-900 placeholder-gray-500" 
                        placeholder="Any specific queries?"
                    ></textarea>
                </div>
                <button type="submit" className="w-full bg-gradient-to-r from-primary to-primaryDark text-white font-bold py-4 rounded-xl shadow-[0_4px_0_rgb(12,74,110)] hover:-translate-y-1 hover:shadow-[0_6px_0_rgb(12,74,110)] active:translate-y-[2px] active:shadow-none transition-all text-lg flex items-center justify-center">
