...
const About: React.FC = () => {
  return (
    <div className="bg-sky-50 min-h-screen">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-primaryDark to-primary py-20 text-center text-white relative shadow-lg">
        <h1 className="text-5xl font-extrabold mb-3 text-shadow">About Us</h1>
        <p className="text-sky-100 text-xl">Our Journey, Vision, and Values</p>
      </div>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          <div className="md:w-2/3">
            ...
            <div className="bg-gradient-to-r from-primary to-blue-900 p-8 rounded-2xl text-white shadow-xl transform hover:-translate-y-1 transition-transform">
              <h3 className="text-2xl font-bold mb-6 flex items-center"><Star className="mr-2 text-sky-400 fill-current" /> Leadership</h3>
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 bg-white p-1 rounded-full shadow-lg flex-shrink-0 overflow-hidden">
          ...
          <div className="md:w-1/3 w-full sticky top-24">
            <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border-t-8 border-secondary">
              ...
              <ul className="space-y-5">
                <li className="flex items-center justify-between">
                   ...
                   <span className="font-bold text-primary bg-sky-50 px-3 py-1 rounded-full">2012</span>
                </li>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="group bg-sky-50 p-10 rounded-3xl border border-sky-100 shadow-lg hover:bg-gradient-to-br hover:from-primary hover:to-blue-800 hover:text-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 className="text-3xl font-bold mb-4 text-primary group-hover:text-white">Vision</h3>
                    <p className="text-gray-600 group-hover:text-sky-100 text-lg leading-relaxed">
                ...
                <div className="group bg-sky-50 p-10 rounded-3xl border border-sky-100 shadow-lg hover:bg-gradient-to-br hover:from-secondary hover:to-blue-600 hover:text-white transition-all duration-300 transform hover:-translate-y-2">
                    <div className="bg-white w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-md group-hover:bg-white/10 group-hover:text-white transition-colors">
                        <Award className="w-8 h-8 text-secondary group-hover:text-white" />
                    </div>
                    <h3 className="text-3xl font-bold mb-4 text-primary group-hover:text-white">Mission</h3>
                    <p className="text-gray-600 group-hover:text-sky-100 text-lg leading-relaxed mb-4">
                        The school joins with parents and the community to enable students to be:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 group-hover:text-white space-y-2 ml-2 font-medium">
                        <li>Innovative</li>
                        <li>Value-driven</li>
      ...
      {/* Code of Ethics */}
      <section className="py-20 container mx-auto px-4">
        <h2 className="text-3xl font-extrabold text-primary mb-12 text-center">Code of Ethics</h2>
        <div className="max-w-4xl mx-auto bg-white border border-gray-200 p-10 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] relative">
...
const EthicItem: React.FC<{ icon: React.ReactNode, text: string }> = ({ icon, text }) => (
    <div className="flex items-center space-x-4 p-5 bg-sky-50 rounded-xl hover:bg-sky-100 hover:shadow-md transition-all">
